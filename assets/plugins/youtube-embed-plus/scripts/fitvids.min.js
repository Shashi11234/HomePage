var epdofitvids = epdofitvids || function(a) {
        ...
        return this.each(function() {
            ...
            h.each(function() {
                ...
                if (n.parent().hasClass("epyt-video-wrapper")) {
                    try {
                        n.parent().addClass("fluid-width-video-wrapper").attr("style", "padding-top: " + (p * 100) + "% !important;");
                    ...
                    try {
                        n.wrap(m).parent(".fluid-width-video-wrapper").attr("style", "padding-top: " + (p * 100) + "% !important;");
                        n.removeAttr("height").removeAttr("width");
                        setTimeout(function() {
                            var r = null;
                            if (typeof(Event) === "function") {
